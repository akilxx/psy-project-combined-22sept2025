...
const BLUE = "#210AA1";   // Tailwind 'blue-400'
    ...
    <div className="w-full overflow-visible">
      ...
      <div className="w-full bg-[#F7F7F7] rounded-lg sm:rounded-xl overflow-visible px-3 sm:px-6 py-2 sm:py-4">
        ...
        >
          {/* filled track */}
          <div
            className="absolute left-0 top-0 h-2 bg-[#210AA1] rounded-md sm:rounded-full transition-[width]"
            style={{ width: `${pct}%` }}
          />
          ...
          {onSeek && !Number.isNaN(thumbPct) && (
            <div
              ...
              style={{
                ...
                backgroundColor: disabled ? GRAY_DISABLED : BLUE, // solid color, no opacity
                borderColor: disabled ? GRAY_DISABLED : BLUE,
              }}
            >
                ...
                >
                  <TearBadgeMini
                    value={thumbIndex + 1}
                    width={64}       /* mobile */
                    fill={disabled ? GRAY_DISABLED : BLUE}
                    stroke={disabled ? GRAY_DISABLED : BLUE}
                    strokeWidth={4}
                    scale={0.7}
                  />
                </div>
